...
//		public void Connect(string port, TextBox logbox, SimulatorForm prog, SimulatorForm f)
//		{
...
//		{
//			var p_a = encodeByte(_simulator.(PICProgramm.ADDR_PORT_A));
//			var t_a = encodeByte(_simulator.GetRegisterOhneBank(PICProgramm.ADDR_TRIS_A));
//			var p_b = encodeByte(_simulator.GetRegisterOhneBank(PICProgramm.ADDR_PORT_B));
//			var t_b = encodeByte(_simulator.GetRegisterOhneBank(PICProgramm.ADDR_TRIS_B));
